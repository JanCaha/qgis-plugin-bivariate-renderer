...
class LegendRenderer:
    ...
    def render(self, context: QgsRenderContext, width: float, height: float, polygons: List[LegendPolygon]):
        ...
        if self.legend_rotated:
            ...
            text_position_x = QPointF(text_position_x.x(),
                                      text_position_x.y())
            
            text_position_y = QPointF(text_position_y.x() - text_height_y,
                                      text_position_y.y())
