...
from tests import assert_images_equal, prepare_QImage
...
def test_color_mixing_direct_mixing(qgis_countries_layer, qgs_layout, prepare_bivariate_renderer):
...
def test_color_mixing_darken(qgis_countries_layer, qgs_project, qgs_layout, prepare_bivariate_renderer):
